...
gulp.task('createInstallers', function() {
  ...
  var osx32Command = './dist/mac/yoursway-create-dmg/create-dmg --volname "Monolist ' + currentVersion + '" --background ./dist/mac/installer-background.png --window-size 480 540 --icon-size 128 --app-drop-link 240 370 --icon "Monolist" 240 110 ./releases/mac/Monolist-' + currentVersion + '-osx32.dmg ./webkitbuilds/Monolist/osx32/ || echo "Create dmg failed, likely caused by not being run on mac, continuing"';
